...
/** @public */
export declare interface ArrayOptions<V = unknown> extends SearchConfiguration {
...
/** @public */
export declare interface StringOptions extends EnumListProps<string>, SearchConfiguration {}
